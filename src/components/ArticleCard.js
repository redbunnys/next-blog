...
const ArticleCard = ({ article, isFirst }) => (
    <div className={`bg-white border border-gray-300 rounded-lg shadow-lg w-full max-w-3xl mb-5 flex flex-col md:flex-row h-full flex-grow transition-transform duration-300 hover:scale-[1.02] hover:z-10 ${isFirst ? 'mt-5' : ''}`}>
        <div className="flex-1 p-5 pl-10 h-full">
            ...
            <div className="flex flex-row">
                <div className="mb-2 text-gray-600">{truncateString(article.excerpt, 30)}</div>
            </div>
            <div className="flex flex-row">
